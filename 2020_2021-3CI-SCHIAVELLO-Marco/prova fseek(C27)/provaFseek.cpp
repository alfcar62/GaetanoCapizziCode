...
*   Params:
*       @param int * scelta : output : scelta utente
*       @return void
*/
void menu(int * scelta)
{
...
*   Params:
*       @param FILE * file: input: file da controllare
*       @return bool : presenza o meno di utenti
*/
bool thereAreUser(FILE * file)
{
    users user;
...
*   Params:
*       @param int return: outoput: codice di stato uscita funzione
