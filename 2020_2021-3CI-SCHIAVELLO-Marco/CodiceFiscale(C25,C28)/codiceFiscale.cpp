...
/**
*    va a verificare se il carattere è accentato o no
*    Params:
...
*    Params:
*       @param char c : input : lettera da controllare per vedere se è una vocale
*       @return bool : dice se la lettera è una vocale
*/
bool isVocale(char c)
{
...
*       @param bool nome = false : input : chiede se la stringa e un nome o cognome poiché cambierà il comportamento della funzione
*       @return void
*/
...
/**
*    chiede il cognome dell'utente e lo controlla, chiede finche non è valido
*    Params:
...
/**
*    chiede il nome dell'utente e lo controlla, chiede finche non è valido
*    Params:
