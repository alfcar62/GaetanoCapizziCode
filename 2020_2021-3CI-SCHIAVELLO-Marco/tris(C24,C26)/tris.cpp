...
*   params:
*       @param char campo[][DIM] : output : campo di gioco che deve essere riempito
*       @param int * turno : output : puntatore che punta al turno del gioco per cambiarlo a quello salvato
*       @param int * nGioc : output : puntatore che punta al numero di giocatori del gioco per cambiarlo a quello salvato
...
*   params:
*       @param char campo[][DIM] : input : campo di gioco che deve essere salvato
